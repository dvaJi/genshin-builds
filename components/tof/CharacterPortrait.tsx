...
const CharacterPortrait = ({ character }: CharacterPortraitProps) => {
  return (
    <div className="hover:bg-tof-600 group relative flex w-full flex-col items-center justify-center rounded-lg p-4">
      ...
      <Image
        ...
        className="absolute left-8 top-16 h-14 w-14 transition-transform group-hover:bg-vulcan-800/70 rounded-full md:left-10 lg:left-16 lg:top-12 xl:left-20"
      ...
      <h2 className="text-tof-50 mt-2 text-lg">{character.name}</h2>
    </div>
  );
};
