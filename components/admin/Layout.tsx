...
function AdminLayout({ children, bgStyle, fontClass }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="hidden w-20 flex-shrink-0 flex-col border-r border-zinc-800 bg-zinc-900 sm:flex">
        ...
        <div className="mx-auto mt-4 flex flex-grow flex-col space-y-4 text-gray-400">
          ...
          <button className="flex h-10 w-12 items-center justify-center rounded-md text-gray-500">
            <svg
              viewBox="0 0 24 24"
              className="h-5"
              stroke="currentColor"
      ...
      <main className="flex h-full flex-grow flex-col overflow-hidden">
        <div className="hidden h-16 w-full border-b border-zinc-800 px-10 lg:flex">
          <Breadcrumb
            homeElement={"Home"}
